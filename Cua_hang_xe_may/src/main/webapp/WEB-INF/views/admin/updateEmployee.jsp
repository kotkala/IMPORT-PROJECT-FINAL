    ...
    <!-- Content Header (Page header) -->
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="ml-2">Sửa Nhân Viên</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <!-- Small boxes (Stat box) -->
            <div class="row">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="post" action="${pageContext.request.contextPath}/admin/updateemployee?action=update&id=<%=employee.getId()%>">
                        ...
                        <div class="row">
                            <div class="col-sm-3 ml-5" data-select2-id="129">
                              ...
                              <select class="form-control select2 select2-danger select2-hidden-accessible" name="accountId" data-dropdown-css-class="select2-danger" style="width: 100%;" data-select2-id="12" tabindex="-1" aria-hidden="true">
                                <option data-select2-id="14">Chọn Tài Khoản</option>
                                ...
                                %>
								 <option data-select2-id="<%= 130 + account.getId() %>" selected value="<%=account.getId()%>"><%=account.getUsername() %> </option>
